...
import { Layers, Linkedin, Twitter, Github, Facebook } from 'lucide-react';
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold tracking-tight">ManPro3</span>
            </Link>
            <p className="text-muted-foreground mb-6 max-w-sm">
              Platform manajemen proyek modern yang dirancang untuk membantu tim Anda bekerja lebih cerdas, bukan lebih keras.
            </p>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} ManPro3. All rights reserved.
          </p>
